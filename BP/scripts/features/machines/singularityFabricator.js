...
const LAYOUT_KEY = "ascendant:singularity_fabricator_layout";
const LAYOUT_VERSION = "contiguous_upgrades_v1";
const INPUT_SLOT = 3;
const FLUID_DISPLAY_SLOT = 8;
...
registerATMachine(ID, {
    ...
    onTick(event, { params: settings }) {
        ...
        if (result.processCount > 0) {
            ...
            // The original is returned separately; preserving that transfer would duplicate it.
