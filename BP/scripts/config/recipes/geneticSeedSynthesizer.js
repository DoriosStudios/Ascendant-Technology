...
export const geneticSoilDefinitions = {
    "minecraft:dirt": { cost: 2 },
    "minecraft:grass_block": { cost: 1.5 },
    "utilitycraft:yellow_soil": { cost: 1 },
...
const geneticDropItemOverrides = {
    "utilitycraft:diamond_seeds": { "minecraft:diamond": "utilitycraft:diamond_shard" },
    "utilitycraft:emerald_seeds": { "minecraft:emerald": "utilitycraft:emerald_shard" },
    "utilitycraft:netherite_seeds": { "minecraft:netherite_scrap": "utilitycraft:netherite_nugget" },
    "utilitycraft:nether_star_seeds": { "minecraft:nether_star": "utilitycraft:nether_star_fragment" },
    "utilitycraft:shulker_seeds": { "minecraft:shulker_shell": "utilitycraft:shulker_shell_shard" },
    "utilitycraft:totem_seeds": { "minecraft:totem_of_undying": "utilitycraft:totem_shard" },
    "utilitycraft:wither_seeds": { "minecraft:wither_skeleton_skull": "utilitycraft:wither_skull_shard" },
};

export const geneticSeedRecipeDefinitions = {
...
registerGeneticSoils(geneticSoilDefinitions);
registerGeneticSeedRecipes(geneticSeedRecipeDefinitions, geneticDropItemOverrides);
