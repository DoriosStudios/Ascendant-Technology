...
export const sieveDropAdditions = {
    "utilitycraft:crushed_cobbled_deepslate": [
        ...
        { item: "utilitycraft:deepslate_tungsten_chunk", amount: 1, chance: 0.075, tier: 5 },
    ],
    "utilitycraft:compressed_crushed_cobbled_deepslate": [
        ...
        { item: "utilitycraft:deepslate_tungsten_chunk", amount: 9, chance: 0.075, tier: 5 },
    ],
    ...
    "utilitycraft:crushed_netherrack": [
        { item: "utilitycraft:nether_tungsten_chunk", amount: 1, chance: 0.15, tier: 5 },
    ],
    "utilitycraft:compressed_crushed_netherrack": [
        { item: "utilitycraft:nether_tungsten_chunk", amount: 9, chance: 0.15, tier: 5 },
    ],
};
