Version 0.5.0 update brings with it several additions, changes, and fixes, with the Cryo Chamber being the main addition.
...
## RECIPES
### General
- Added recipes for the missing machines:
  - Absolute Battery
  - Absolute Container
  - Network Center
  - Singurlarity Fabricator
...
- Reworked Absolute Container UI entirely.
  - It also uses a dark-themed instead of a normal one.
