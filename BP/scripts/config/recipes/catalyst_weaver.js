...
/**
 * Example: How to register Catalyst Weaver recipes from another script
 * 
 * In another script file (e.g., `custom_recipes.js`):
 * 
 * import { system } from "@minecraft/server"
 * 
 * function registerCustomCatalystWeaverRecipes() {
 *     const customRecipes = {
 *         'utilitycraft:custom_alloy': {
 *             input: { id: 'minecraft:iron_ingot', amount: 2 },
 *             catalysts: [
 *                 { id: 'minecraft:copper_ingot', amount: 1 },
 *                 { id: 'minecraft:gold_ingot', amount: 1 }
 *             ],
 *             output: { id: 'utilitycraft:custom_alloy', amount: 1 },
 *             cost: 8000,
 *             speedModifier: 1.5
 *         },
 *         'utilitycraft:enhanced_crystal': {
 *             input: { id: 'minecraft:amethyst_shard', amount: 2 },
 *             catalysts: [
 *                 { id: 'utilitycraft:aetherium_shard', amount: 1 },
 *                 { id: 'minecraft:glowstone_dust', amount: 3 },
 *                 { id: 'utilitycraft:energized_iron_dust', amount: 1 }
 *             ],
 *             fluid: { type: 'lava', amount: 5000 },
 *             output: { id: 'utilitycraft:enhanced_crystal', amount: 1 },
 *             byproduct: { id: 'minecraft:quartz', amount: [1, 2], chance: 0.4 },
 *             cost: 6400,
 *             speedModifier: 2.0
 *         }
 *     }
 * 
 *     system.run(() => {
 *         system.events.scriptEventReceive.emit({
 *             id: 'utilitycraft:register_catalyst_weaver_recipe',
 *             message: JSON.stringify(customRecipes)
 *         })
 *     })
 * }
 * 
 * registerCustomCatalystWeaverRecipes()
 */