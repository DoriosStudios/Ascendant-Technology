/** @type {Readonly<Record<string, ReadonlyArray<{ item: string, amount: number, chance: number, tier: number }>>>} */
export const sieveDropAdditions = Object.freeze({
    "utilitycraft:crushed_cobbled_deepslate": Object.freeze([
    ...
    "utilitycraft:compressed_crushed_cobbled_deepslate": Object.freeze([
    ...
    "utilitycraft:crushed_endstone": Object.freeze([
        { item: "utilitycraft:aetherium_shard", amount: 1, chance: 0.1, tier: 5 },
    ]),
    "utilitycraft:compressed_crushed_endstone": Object.freeze([
