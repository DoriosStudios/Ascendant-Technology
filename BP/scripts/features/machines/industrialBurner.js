...
const OUTPUTS = Object.freeze([5, 6, 7]);
const PROGRESS_SLOTS = Object.freeze([8, 9, 10]);
const LAVA_DISPLAY_SLOT = 11;
...
registerIOInterface(ID, {
    items: {
        ...
        modes: [
            ...
            { id: "output_2", outputSlots: [6] },
            { id: "output_3", outputSlots: [7] },
