...
Below are the native Catalyst Weaver recipes. Registered UtilityCraft Infuser recipes are also imported automatically and converted to catalyst format by `BP/scripts/config/recipes/catalystWeaver.js`.
