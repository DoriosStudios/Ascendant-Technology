...
world.afterEvents.worldLoad.subscribe(() => {
    const newRecipes = {
        ...
        "utilitycraft:titanium_block": { output: "utilitycraft:titanium_dust", amount: 6, cost: 21600, tier: 5 },
        "utilitycraft:raw_titanium": { output: "utilitycraft:titanium_dust", amount: 2, cost: 2400, tier: 5 },
        "utilitycraft:raw_titanium_block": { output: "utilitycraft:titanium_dust", amount: 12, cost: 21600, tier: 5 }
    };
