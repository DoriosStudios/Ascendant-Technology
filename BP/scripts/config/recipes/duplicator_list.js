const CLONER_RARITY_DATA = Object.freeze({
...
function buildClonerBlockRarityMap() {
    const map = {};
    addEntriesToMap(map, CLONER_RARITY_DATA.vanilla.blocks.common, "common");
    addEntriesToMap(map, CLONER_RARITY_DATA.vanilla.blocks.uncommon, "uncommon");
    addEntriesToMap(map, CLONER_RARITY_DATA.vanilla.blocks.rare, "rare");
    addEntriesToMap(map, CLONER_RARITY_DATA.vanilla.blocks.epic, "epic");
    addEntriesToMap(map, CLONER_RARITY_DATA.vanilla.blocks.legendary, "legendary");
    addEntriesToMap(map, CLONER_RARITY_DATA.vanilla.blocks.mythic, "mythic");
    addEntriesToMap(map, CLONER_RARITY_DATA.vanilla.blocks.transcendent, "transcendent");
    Object.assign(map, CLONER_RARITY_DATA.ascendant.blocks);
    return map;
}
...
export const CLONER_ITEM_RARITY_MAP = Object.freeze({
    ...CLONER_RARITY_DATA.ascendant.items,
    ...Object.fromEntries([...CLONER_RARITY_DATA.vanilla.items.common].map(id => [id, "common"])),
    ...Object.fromEntries([...CLONER_RARITY_DATA.vanilla.items.uncommon].map(id => [id, "uncommon"])),
    ...Object.fromEntries([...CLONER_RARITY_DATA.vanilla.items.rare].map(id => [id, "rare"])),
    ...Object.fromEntries([...CLONER_RARITY_DATA.vanilla.items.epic].map(id => [id, "epic"])),
    ...Object.fromEntries([...CLONER_RARITY_DATA.vanilla.items.legendary].map(id => [id, "legendary"])),
    ...Object.fromEntries([...CLONER_RARITY_DATA.vanilla.items.mythic].map(id => [id, "mythic"])),
    ...Object.fromEntries([...CLONER_RARITY_DATA.vanilla.items.transcendent].map(id => [id, "transcendent"]))
});

export const CLONER_RARITIES = CLONER_RARITY_DATA.rarities;
