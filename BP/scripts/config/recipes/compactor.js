...
export const COMPACTOR_CONFIG = Object.freeze({
    ...
    chains: Object.freeze([
        ...
        ["utilitycraft:netherite_nugget", "minecraft:netherite_ingot", "minecraft:netherite_block"],
        ["utilitycraft:steel_nugget", "utilitycraft:steel_ingot", "utilitycraft:steel_block"],
        ["utilitycraft:lead_nugget", "utilitycraft:lead_ingot", "utilitycraft:lead_block"],
        [
    ...
    materialCompactions: Object.freeze([
        ["utilitycraft:aetherium_crystal", "utilitycraft:aetherium_crystal_block", 4],
        ["utilitycraft:raw_steel", "utilitycraft:raw_steel_block", 9],
        ["utilitycraft:raw_lead", "utilitycraft:raw_lead_block", 9],
        ["utilitycraft:raw_energized_iron", "utilitycraft:raw_energized_iron_block", 9],
        ["utilitycraft:silicon", "utilitycraft:silicon_block", 9],
    ...
    fragmentCompactions: Object.freeze([
        ["utilitycraft:aetherium_shard", "utilitycraft:aetherium_crystal", 4],
        ...
        ["utilitycraft:lead_chunk", "utilitycraft:lead_ore", 4],
        ["utilitycraft:deepslate_lead_chunk", "utilitycraft:deepslate_lead_ore", 4],
