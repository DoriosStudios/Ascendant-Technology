...
Below are the native Catalyst Weaver recipes. Infuser recipes are also imported automatically and converted to catalyst format (see `BP/scripts/config/recipes/infuser_registry.js`).
